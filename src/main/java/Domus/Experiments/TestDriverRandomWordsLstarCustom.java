...
public class TestDriverRandomWordsLstarCustom {
    //using custom Json
    public static void main(String[] args) throws IOException {
        // setting up dataset
        Dataset datasetSeries1 = readJson("./CustomJson2.json");
        Dataset datasetSeries2 = readJson("./CustomJson2.json");
        int nUsers = 2;
        int nDays = 2;
        ...
        // equivalence oracle
        EquivalenceOracle.DFAEquivalenceOracle<DomusRecord> eqOracle = new DFARandomWordsEQOracle<>(mOracle, 3, 4, 10);
        ...
        executeExperiment(nUsers,nDays,lStarDFA,eqOracle,ExperimentType.TESTDRIVER_RANDOMWORDS_LSTAR,false,"Custom2-10");
